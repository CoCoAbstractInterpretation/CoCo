...
function searchModule(moduleName, requiredBy) {
    var selfBuiltPackages = ['yargs', 'execa', 'express', 'send', 'async',
      'undefsafe', 'thenify', 'codecov', 'class-transformer', 'dot-object', 'git-revision-webpack-plugin', 'aws-lambda', 'vsce', 'blamer', 'git-diff-apply', 'rollup-plugin-serve', 'gulp-scss-lint', 'devcert-sanscache', 'clamscan', 'pixl-class', 'node-rules', 'lsof', 'bodymen', 'component-flatten', 'paypal-adaptive', 'levelup'];
