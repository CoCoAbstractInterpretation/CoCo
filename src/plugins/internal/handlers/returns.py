...
class HandleReturn(Handler):
    def process(self):
        ...
        self.G.function_returns[self.G.find_ancestor_scope()][2].append(branch)
        return results
